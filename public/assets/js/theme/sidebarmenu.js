...
if ((at = "vertical")) {
    ...
    if (currentNewURL.includes("/main/index.html")) {
        ...
        // Now you can use these values in JavaScript
        // if ($("#usertypecode").val()) {
        var value = document.getElementById("usertypecode").value;
        // Example of setting href based on session variables
        // if (value === "I") {
        //     current_link.setAttribute("href", "auditeedashboard");
        // } else {
        //     current_link.setAttribute("href", "dashboard");
        // }
        //}
