@section('content')
    ...
    <script>
        ...
        function reset_form() {
            ...
            initialize_date();
            fetchAlldata();
            change_button_as_insert('leave_form', 'action', 'buttonaction', 'display_error', '', '');
        ...
        function forward_application(forwardto_userid, forwardto_userchargeid, leaveid, transtypecode) {

            var roleactioncode = '<?php echo $userroleactioncode; ?>';
            $.ajax({
                url: '/transaction/forward_application', // Your API route to get user details
                method: 'POST',
                data: {
                    userid: forwardto_userid,
