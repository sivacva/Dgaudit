...
@endif -->
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label required lang" key="subobjectionename" for="subobjectionename">
                                Sub Objection English Name</label>
                            <input type="text" class="form-control text_special" id="subobjectionename"
                                name="subobjectionename" maxlength="300" placeholder="Sub Objection English name"
                                data-placeholder-key="subobjectionename" required />
                        </div>
                        <div class="col-md-4 mb-3">
    ...
    jsonLoadedPromise.then(() => {
        ...
        $("#buttonaction").on("click", function(event) {
            ...
            if ($("#subobjectionform").valid()) {
                ...
                $.ajax({
                    url: "{{ route('subobjectionhome.subobjection_insertupdate') }}",
                    type: 'POST',
                    data: formData,
                    success: function(response) {
                        if (response.success) {
