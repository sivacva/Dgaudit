...
<head>
    ...
    @media (max-width: 454px) {
        ...
        .captcha-image {
            ...
            max-width: 250px !important;  /* Limit the max width */
                    ...
                    <div id="display_error"class="alert alert-danger alert-dismissible fade show hide_this"
                        ...
                        <label class="form-check-label text-dark" for="flexCheckChecked">
                            Remeber this Device
                                        ...
                                        <a href="{{ url('/forgetpassword?user=auditor') }}" class="text-primary fw-medium">Forgot
                                            Password ?</a>
                                    </div>
...
async function loginuser() {
    ...
    {
        $.ajax({
    url: '{{ route('captcha.reload') }}', // Correct route name
    type: 'GET',
    ...
    if (target.attr('type') === 'password') {
      ...
      icon.removeClass('fa-eye-slash').addClass('fa-eye'); // Change icon to eye
        ...
        $("#username, #password").on("input", function() {
            $("#usernameAlert").addClass("d-none").removeClass("show");
        });
        $(document).ready(function() {
            $.ajaxSetup({
                headers: {
