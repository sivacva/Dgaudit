...
<main class="fullscreen-center">
    ...
    <h5 class='lang' key='term'>Terms & Conditions</h5>
        </div>
        <div class="mt-1 p-4 ">
        <div class="d-flex justify-content-between align-items-center pr-4">
        <h5 class="mb-1"><b key='terms_head' class='lang'>Terms of Use</b></h5>
       
    </div>
    <ul>
  <li>
    <p key='terms_head_p1' class='lang'>
      This website, Comprehensive Audit Management System (CAMS), is hosted by the Director General of Audit Department - Finance, Government of Tamil Nadu. 
      It has been designed and developed by the National Informatics Centre, Government of India, in consultation with the Director General of Audit Department. 
      The content is owned and maintained by the Director General of Audit Department.
    </p>
  </li>
  <li>
    <p key='terms_head_p2' class='lang'>
      Non-compliance with the terms of use and privacy policy may result in the immediate blocking of the violated user's access rights to this system upon authentic proof provided through the Contact Us link. 
      In no event will the Organization/Department or NIC be liable for any expense, loss, or damage arising from the use of this portal.
    </p>
  </li>
  <li>
    <p key='terms_head_p3' class='lang'>
      These terms and conditions are governed by Indian laws, and any dispute shall be subject to the exclusive jurisdiction of the Madras High Court.
    </p>
  </li>
</ul>
