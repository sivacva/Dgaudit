...
<main class="fullscreen-center">
    ...
    <h5 class='lang' key='screenreaderheading'>Screen Reader</h5></div>
        <div class="mt-1 ml-4 body-content">
    <!-- FLEX container for heading and home button -->
    <div class="d-flex justify-content-between align-items-center pr-4">
        <h5 class="mb-1"><b class='lang' key='screenreaderhead'>Screen Reader - NVDA</b></h5>
      
    </div>

    <!-- Content below the heading -->
    <p class="mb-2 lang" class='' key='screen_point1'>1. Download the Screen Reader Access software from the below link.</p>
    <p class="mb-2 lang" class='lang' key='screen_point2'>2. https://www.nvaccess.org/download/</p>
    <p class="mb-2 lang" class='lang' key='screen_point3'>3. Screen reader Access to enable people with visual impairments access the website using assistive technologies, such as screen readers.</p>

    <h5 class="mb-1 lang"><b key='screen_head2' class='lang'>Steps to enable the screen reader</b></h5>
    <p class="mb-2 lang" key='screen_head_1'>1. Download the software from the link provided.</p>
    <p class="mb-2 lang" key='screen_head_2'>2. Run the executable file</p>
    <p class="mb-2 lang" key='screen_head_3'>3. Screen reader will be enabled automatically.</p>
    <p class="mb-2 lang" key='screen_head_4'>4. It can be configured to function on loading of Windows OS itself.</p>

    <h5 class="mb-1 lang"><b key='screen_headcontrol' class='lang'>Control Keys</b></h5>
    <p class="mb-2 lang" key='screen_head3_1'>a. 'Ctrl' key will 'Stop' the audio.</p>
    <p class="mb-2 lang" key='screen_head3_2'>b. 'Shift' key will 'Pause' the audio.</p>
    <p class="mb-2 lang" key='screen_head3_3'>c. 'Insert' key will 'Restart' the audio again.</p>
</div>
