...
<main class="fullscreen-center">
    ...
    @include('layouts.header_elements')
        ...
        <div class="text-center py-4  top-border align-middle header" style="background-color: rgba(20, 71, 160, 0.8); color: white; ">
            <h3 class='lang' key='disclaimer'>Disclaimer</h3>
        </div>
        <div class="mt-1 p-4 ">
        <div class="d-flex justify-content-between align-items-center pr-4">
        <h5 class="mb-1"><b key='goverment_title' class='lang'>Government Websites</b></h5>
       
    </div>

            
    <ul>
  <li key='disclaimer_p1' class='lang'>
    The contents of this website are owned and maintained by the Director General of Audit Department - Finance.
    While every care has been taken to ensure the accuracy of information furnished, the Director General of Audit Department / NIC
    does not accept any responsibility for any damage or loss from direct/indirect use of this information.
    Please report errors/omissions for correction.
  </li>
  
  <li key='disclaimer_p2' class='lang'>
    Certain links may lead to third-party resources we do not control. We accept no responsibility for their content.
  </li>
</ul>

<h5><b key='onlinecontent' class='lang'>Online Content</b></h5>

<ul>
  <li key='disclaimer_p3' class='lang'>
    The content on this website is for general informational purposes. While we aim to keep it accurate and up to date,
    we make no warranties of any kind regarding accuracy, reliability, or availability. Use this information at your own risk.
  </li>

  <li key='disclaimer_p4' class='lang'>
    We are not liable for any loss or damage, including indirect or consequential losses, or loss of data or profits arising
    from the use of this website.
  </li>

  <li key='disclaimer_p5' class='lang'>
    Links to external websites are provided for convenience. We have no control over the content or availability of those sites.
  </li>
</ul>
