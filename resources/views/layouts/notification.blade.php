...
<main class="fullscreen-center">
    ...
    <section class="disclaimer-text bg-white rounded mt-5">
        <div class="text-center py-3 top-border header" style="background-color: rgba(20, 71, 160, 0.8); color: white;">
            <h3 class='lang' key='noti'>Latest Circular</h3>
        </div>
        <div class="mt-1 p-4 ">
        ...
        <h5 class="mb-1"><b></b></h5>
          ...
          <center>  <p key='construct' class='lang'>
